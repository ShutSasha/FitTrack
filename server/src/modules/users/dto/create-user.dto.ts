...
export class CreateUserDto {
  ...
  @IsString({ message: 'Should be a string' })
  @IsNotEmpty()
  @Length(8, 24, { message: 'Password should not be less than 8 and no more than 24' })
...
export class RegisterUserDto extends CreateUserDto {
  ...
  @IsString({ message: 'Should be a string' })
  @IsNotEmpty()
  @Length(8, 24, { message: 'Confirm password should not be less than 8 and no more than 24' })
