...
export class Meal {
  ...
  @ApiProperty({
    example: [{ nutritionProduct: '64eabf891c85a90fc8f3e7e5', amount: 100 }],
    description: 'Array of nutrition products with their IDs and amounts (in grams or other units)',
  })
  @Prop({
    type: [{ nutritionProduct: { type: mongoose.Schema.Types.ObjectId, ref: 'NutritionProduct' }, amount: Number }],
    default: [],
  })
  nutritionProducts: { nutritionProduct: Types.ObjectId; amount: number }[]
}
